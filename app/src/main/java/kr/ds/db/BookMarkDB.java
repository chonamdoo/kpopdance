...
public class BookMarkDB {
    ...
    private static final String DATABASE_CREATE = "create table billiards (_id integer primary key autoincrement, " +
    																"contents_id text not null "+
    																");";    
    private static final String DATABASE_NAME = "billiards.db";
    private static final String DATABASE_TABLE = "billiards";
