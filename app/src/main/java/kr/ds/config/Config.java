...
public class Config {
	...
	public static final String PREFERENCE_NEW = "2017-09-11-01";
	...
	public static String APP_DOWN_URL_MARKET = "kr.ds.kpopdance";
	public static String APP_DOWN_TITLE = "무료배드민턴레슨";
